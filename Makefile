...
all: dist/cesdecode.js      dist/cesdecode-impl.js \
     dist/cesdecodecp932.js dist/cesdecodecp932-impl.js

dist/cesdecode.js: src/cesdecode.js dist/cesdecode-impl.js
	@mkdir -p dist
	$(CPP) -I./dist < $< > $@

dist/cesdecodecp932.js: src/cesdecodecp932.js dist/cesdecodecp932-impl.js
	@mkdir -p dist
	$(CPP) -I./dist < $< > $@

dist/cesdecode-impl.js: src/cesdecode-impl.js med/cp932.json med/sjis2004.json med/eucjis2004.json
	@mkdir -p dist
	$(CPP) -I./med -I./src < $< > $@

dist/cesdecodecp932-impl.js: src/cesdecodecp932-impl.js med/cp932.json
	@mkdir -p dist
	$(CPP) -I./med -I./src < $< > $@
...
clean:
	rm -f \
		...
		dist/cesdecode-impl.js dist/cesdecodecp932-impl.js \
